 ...
 */
void logger_set_date_format( const char *s );
 ...
 */
void logger_set_log_level( const char *type );
 ...
 *
 *  @param df string with dateformat inside.
 *  @param ll string with loglevel (text) inside.
 */
void logger_config( const char *df, const char *ll );
